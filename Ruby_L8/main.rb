...
class Menu
  ...
  def info_train
    ...
    @trains.each_with_index do |train, index|
      ...
      puts "Маршрут: #{train.route.show_route.map {|station| station.station_name}}"
  ...
  def info_route
    ...
    @routes.each_with_index do |route, index|
      ...
      puts "Наименование маршрута: #{route.show_route.map { |station| station.station_name}}"
    end
  end
  ...
  def wagons_manage
    ...
    if @wagons[wagon_index].class == CargoWagon
      ...
      puts "Вагон заполнен"
    elsif @wagons[wagon_index].class == PassengerWagon
